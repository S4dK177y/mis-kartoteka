...
В рамках проекта выстроены процессы мануального тестирования и контроля качества. Все артефакты тестирования хранятся в директории [`docs/qa`](./docs/qa/):
...
- **[Test Run Report](./docs/qa/exports/04_Test_Run_Report.pdf)**: Итоговый отчет о результатах мануального тестирования.
